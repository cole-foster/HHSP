 ...
 */
void GHSP::pivotNNS(unsigned int const queryIndex, PivotLayer &pivotLayer, SparseMatrix &sparseMatrix,
    ...
    for (it1 = pivotIndices.begin(); it1 != pivotIndices.end(); it1++) {
        ...
        float const distance_Qp = getQueryDistance(queryIndex, pivotIndex, sparseMatrix, queryDistances);
